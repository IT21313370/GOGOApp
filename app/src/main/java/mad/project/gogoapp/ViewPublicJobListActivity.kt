...
import mad.project.gogoapp.databinding.ActivityViewPublicJobListBinding


class ViewPublicJobListActivity : AppCompatActivity() {

    private lateinit var binding: ActivityViewPublicJobListBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityViewPublicJobListBinding.inflate(layoutInflater)
    ...
    private fun loadCategories() {
        ...
        ref.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                //setup adapter
                adapterJob = AdapterJob(this@ViewPublicJobListActivity, jobArrayList)
